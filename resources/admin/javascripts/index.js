...
function initCategoryBehavior(){
	var chart = echarts.init(document.getElementById('category-behavior'));
    // 指定图表的配置项和数据
    var option = {
        title: {
            text: '行为'
...
function initCategoryRead(){
	var chart = echarts.init(document.getElementById('category-read'));
	// 指定图表的配置项和数据
	var option = {
	    title: {
	        text: '阅读量'
...
function initArticleBehavior(){
	var chart = echarts.init(document.getElementById('article-behavior'));
	// 指定图表的配置项和数据
	var option = {
			title: {
				text: '行为'
...
function initArticleRead(){
	var chart = echarts.init(document.getElementById('article-read'));
	// 指定图表的配置项和数据
	var option = {
			title: {
				text: '阅读量'
...
function initVisitorPosition(){
	var chart = echarts.init(document.getElementById('visitor-position'));
	// 指定图表的配置项和数据
	var geoCoordMap = {
	    "北京": [116.46, 39.92],
	    "南京": [118.78, 32.04],
